...
p3d::Shader::Shader(const char* vertexPath, const char* fragmentPath)
{
...
void p3d::Shader::setBool(const std::string& name, bool value) const
{
    glUniform1i(glGetUniformLocation(ID, name.c_str()), (int)value);
}

void p3d::Shader::setInt(const std::string& name, int value) const
{
